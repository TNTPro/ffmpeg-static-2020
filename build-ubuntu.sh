...
sudo apt install autoconf autoconf-archive automake cmake curl gawk git gperf libtool ragel texi2html help2man doxygen po4a xmlto libtool-bin autogen autopoint yasm bison flex subversion mercurial
